                    ...
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            <div class="product-card">
                                <img src="https://via.placeholder.com/350x250/5955B3/FFFFFF?text=Login+Form"
                                    alt="Form Login">
                            </div>
                        </div>
                        <div class="swiper-slide">
                            <div class="product-card">
                                <img src="https://via.placeholder.com/350x250/7773C7/FFFFFF?text=Dashboard"
                                    alt="Dashboard">
                            </div>
                        </div>
                        <div class="swiper-slide">
                            <div class="product-card">
                                <img src="https://via.placeholder.com/350x250/FF6B35/FFFFFF?text=Menu+Management"
                                    alt="Menu">
                            </div>
                        </div>
                        <div class="swiper-slide">
                            <div class="product-card">
                                <img src="https://via.placeholder.com/350x250/28A745/FFFFFF?text=Add+Menu"
                                    alt="Tambah Menu">
                            </div>
                        </div>
                        <div class="swiper-slide">
                            <div class="product-card">
                                <img src="https://via.placeholder.com/350x250/FFC107/000000?text=Frontend+View"
                                    alt="Tampilan">
                            </div>
                        </div>
                        <div class="swiper-slide">
                            <div class="product-card">
                                <img src="https://via.placeholder.com/350x250/DC3545/FFFFFF?text=Theme+Options"
                                    alt="Tampilan 2">
                            </div>
                        </div>
                    </div>
        ...
        <div class="demo-container">
            <div class="demo-content">
                ...
                <div class="demo-guarantee">
                    ...
                    <span>100% Gratis untuk mencoba - Tidak ada biaya tersembunyi</span>
                </div>
            </div>
    ...
    <style>
        * {
        ...
        .demo-cta-section {
            ...
            padding: 3rem 0;
            /* Mengubah dari 6rem menjadi 3rem untuk membuatnya lebih pendek */
            position: relative;
            overflow: hidden;
