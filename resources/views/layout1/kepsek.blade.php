          ...
          <div class="col-lg-6">
            <div class="about-content" data-aos="fade-up" data-aos-delay="200">
              ...
              <p>Assalamu’alaikum warahmatullahi wabarakatuh,<br>
                ...
                Puji syukur kita panjatkan ke hadirat Allah SWT atas limpahan rahmat dan karunia-Nya, sehingga kita
                semua senantiasa diberikan kesehatan, kesempatan, dan kekuatan untuk terus berkarya dan berprestasi.

                SMKN 4 Malang senantiasa berkomitmen untuk menjadi lembaga pendidikan yang unggul dalam membentuk
                generasi yang berkarakter, terampil, serta siap menghadapi tantangan dunia kerja dan perkembangan zaman.
                Melalui dukungan seluruh guru, staf, peserta didik, dan orang tua, kami terus berupaya meningkatkan mutu
                pendidikan, sarana prasarana, serta layanan sekolah agar mampu mencetak lulusan yang berdaya saing
                tinggi.

                Kami berharap website/agenda/kegiatan ini dapat menjadi sarana informasi dan komunikasi yang bermanfaat,
                serta jembatan antara sekolah dengan masyarakat luas. Mari bersama-sama kita dukung anak-anak kita agar
                tumbuh menjadi pribadi yang cerdas, berakhlak mulia, dan siap menjadi bagian dari pembangunan bangsa.
      ...
      <div class="container" data-aos="fade-up" data-aos-delay="100">
          ...
          <div class="row align-items-center">
            <div class="col-lg-6 order-lg-2 mb-5 mb-lg-0" data-aos="zoom-in" data-aos-delay="200">
              <div class="intro-image">
                ...
                <img src="{{asset('assets/img/education/teacher-5.webp')}}" alt="School Leadership"
            ...
            <div class="col-lg-6 order-lg-1" data-aos="fade-up" data-aos-delay="300">
              <div class="intro-content">
                ...
                <p class="description">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Etiam auctor euismod
                  lobortis. Mauris ornare ante non justo mattis, vitae fermentum est commodo. Morbi eget tristique
                  justo. Mauris id tellus tempus, ornare ligula egestas, ultricies libero.</p>
        ...
        <div class="leadership-section" data-aos="fade-up">
          <div class="section-header text-center">
            ...
            <p class="description">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nunc aliquet scelerisque
              pellentesque. Praesent vestibulum scelerisque scelerisque.</p>
          </div>
                ...
                <div class="card-inner">
                  <div class="card-front">
                    <div class="member-image">
                      ...
                      <img src="{{asset('assets/img/person/person-f-7.webp')}}" alt="Admissions Director"
                        class="img-fluid">
                ...
                <div class="card-inner">
                  <div class="card-front">
                    <div class="member-image">
                      ...
                      <img src="{{asset('assets/img/person/person-m-8.webp')}}" alt="Technology Director"
                        class="img-fluid">
                ...
                <div class="card-inner">
                  <div class="card-front">
                    <div class="member-image">
                      ...
                      <img src="{{asset('assets/img/person/person-m-3.webp')}}" alt="Athletics Director"
                        class="img-fluid">
